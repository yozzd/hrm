...
export const KARYAWAN_CREATE = gql`
  mutation karyawanCreate(
    $no: String!
    $nama: String!
    $personal: KaryawanPersonalInputType
  ) {
...
export const KARYAWAN_CREATE_KELUARGA = gql`
  mutation karyawanKeluargaCreate(
    $id: String!
    $keluarga: KaryawanKeluargaInputType
  ) {
...
export const KARYAWAN_UPDATE_KELUARGA = gql`
  mutation karyawanKeluargaUpdate(
    $id: String!
    $keluarga: KaryawanKeluargaInputType
  ) {
...
export const KARYAWAN_DELETE_KELUARGA = gql`
  mutation karyawanKeluargaDelete(
    $id: String!
    $delete: [KaryawanDeleteInputType]!
  ) {
...
export const KARYAWAN_CREATE_KONTAK = gql`
  mutation karyawanKontakCreate(
    $id: String!
    $kontak: KaryawanKontakInputType
  ) {
