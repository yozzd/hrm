      ...
      editForm: {
        forms: [
          ...
          },
          {
            ...
            dotProp: 'personal.tanggalBergabung',
            label: 'Tanggal Bergabung',
            itemType: 'date',
            placeholder: '__-__-____',
            rules: [
          ...
          },
          {
            ...
            dotProp: 'personal.statusPernikahan',
            label: 'Status Pernikahan',
            itemType: 'select',
          ...
          try {
            const { data } = await this.$apollo.mutate({
              ...
              update: (store, { data: { karyawanUpdate } }) => {
                ...
                const merge = _.merge(
                  data,
                  _.merge(data.karyawanDetail, karyawanUpdate),
                );
                store.writeQuery({
                  query: KARYAWAN_PERSONAL,
                  variables: {
